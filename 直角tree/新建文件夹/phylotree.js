    ...
    n(n.s = 60)
        ...
        t.exports = function() {
            function t(t) {
                ...
                this.children = [],
                s || (s = n(21), e = n(20), r = n(19), i = n(18), o = n(17), u = n(12), c = n(11), a = n(10))
            }
            return t.prototype.element = function(t, e, n) {
                var r, i, o, s, a, u, c, p, y, g;
                if (u = null, null == e && (e = {}), e = e.valueOf(), f(e) || (n = (y = [e, n])[0], e = y[1]), null != t && (t = t.valueOf()), Array.isArray(t)) for (o = 0, c = t.length; o < c; o++) i = t[o],
                u = this.element(i);
                else if (h(t)) u = this.element(t.apply());
                else if (f(t)) {
                    for (a in t) if (d.call(t, a)) if (g = t[a], h(g) && (g = g.apply()), f(g) && l(g) && (g = null), !this.options.ignoreDecorators && this.stringify.convertAttKey && 0 === a.indexOf(this.stringify.convertAttKey)) u = this.attribute(a.substr(this.stringify.convertAttKey.length), g);
                    else if (!this.options.separateArrayItems && Array.isArray(g)) for (s = 0, p = g.length; s < p; s++) i = g[s],
                    (r = {})[a] = i,
                    u = this.element(r);
            ...
            t.prototype.instruction = function(t, e) {
                var n, r, i, o, s;
                if (null != t && (t = t.valueOf()), null != e && (e = e.valueOf()), Array.isArray(t)) for (o = 0, s = t.length; o < s; o++) n = t[o],
                this.instruction(n);
                else if (f(t)) for (n in t) d.call(t, n) && (r = t[n], this.instruction(n, r));
                else h(e) && (e = e.apply()),
                i = new a(this, t, e),
            ...
            t.prototype.doctype = function(t, e) {
                ...
                for (n = this.document(), r = new o(n, t, e), i = s = 0, u = (l = n.children).length; s < u; i = ++s) if (l[i] instanceof o) return n.children[i] = r,
                r;
                for (i = a = 0, c = (h = n.children).length; a < c; i = ++a) if (h[i].isRoot) return n.children.splice(i, 0, r),
                r;
...
function(t, e) {
    ...
    n.prototype.emit = function(t) {
        ...
        default:
            ...
            n.apply(this, a)
        } else if (i(n)) for (a = Array.prototype.slice.call(arguments, 1), s = (c = n.slice()).length, u = 0; u < s; u++) c[u].apply(this, a);
        return ! 0
    },
    n.prototype.addListener = function(t, e) {
        ...
        i(this._events[t]) && !this._events[t].warned && (s = o(this._maxListeners) ? n.defaultMaxListeners: this._maxListeners) && s > 0 && this._events[t].length > s && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace()),
        this
    },
    ...
    n.prototype.removeListener = function(t, e) {
        ...
        if (s = (n = this._events[t]).length, o = -1, n === e || r(n.listener) && n.listener === e) delete this._events[t],
...
function(t, e, n) { (function() {
        ...
        t.exports = function(t) {
            function n(t, e, i, o) {
                var s;
                n.__super__.constructor.call(this, t),
                r(e) && (e = (s = e).version, i = s.encoding, o = s.standalone),
                e || (e = "1.0"),
...
function(t, e, n) { (function() {
        ...
        t.exports = function(t) {
            ...
            n.prototype.clone = function() {
                var t, e, n, r;
                for (e in (n = Object.create(this)).isRoot && (n.documentObject = null), n.attributes = {},
                r = this.attributes) a.call(r, e) && (t = r[e], n.attributes[e] = t.clone());
                return n.children = [],
            ...
            n.prototype.attribute = function(t, n) {
                var r, s;
                if (null != t && (t = t.valueOf()), o(t)) for (r in t) a.call(t, r) && (s = t[r], this.attribute(r, s));
                else i(n) && (n = n.apply()),
            ...
            n.prototype.removeAttribute = function(t) {
                ...
                if (t = t.valueOf(), Array.isArray(t)) for (n = 0, r = t.length; n < r; n++) e = t[n],
...
function(t, e, n) {
    ...
    o.prototype.text = function(t, e) {
        var n = function(t, e, n) {
            ...
            i;
            if (--r < n || -2 === i) return 0;
            if ((i = s(e[r])) >= 0) return i > 0 && (t.lastNeed = i - 2),
            i;
            if (--r < n || -2 === i) return 0;
            if ((i = s(e[r])) >= 0) return i > 0 && (2 === i ? i = 0 : t.lastNeed = i - 3),
            i;
            return 0
        } (this, t, e);
        ...
        function m(t, e) {
            ...
            this.onwrite = function(t) { !
                function(t, e) {
                    ...
                    function(t, e, n, r, i) {--e.pendingcb,
                        n ? (o.nextTick(i, r), o.nextTick(x, t, e), t._writableState.errorEmitted = !0, t.emit("error", r)) : (i(r), t._writableState.errorEmitted = !0, t.emit("error", r), x(t, e))
                    } (t, n, r, e, i);
                    else {
                        var s = E(n);
...
function(t, e, n) { (e = t.exports = n(33)).Stream = e,
    e.Readable = e,
    e.Writable = n(23),
    e.Duplex = n(2),
    e.Transform = n(29),
 ...
 */
        ...
        function T(t, e, n, r) {
            return z(function(t, e) {
                for (var n, r, i, o = [], s = 0; s < t.length && !((e -= 2) < 0); ++s) n = t.charCodeAt(s),
                r = n >> 8,
                i = n % 256,
                o.push(i),
                o.push(r);
        ...
        u.compare = function(t, e) {
            ...
            r = e.length,
            i = 0,
            o = Math.min(n, r); i < o; ++i) if (t[i] !== e[i]) {
                n = t[i],
                r = e[i];
                break
            }
        ...
        u.prototype.compare = function(t, e, n, r, i) {
            ...
            for (var o = i - r,
            s = n - e,
            a = Math.min(o, s), c = this.slice(r, i), l = t.slice(e, n), h = 0; h < a; ++h) if (c[h] !== l[h]) {
                o = c[h],
                s = l[h];
                break
            }
        ...
        u.prototype.writeUIntLE = function(t, e, n, r) { (t = +t, e |= 0, n |= 0, r) || P(this, t, e, n, Math.pow(2, 8 * n) - 1, 0);
            var i = 1,
            o = 0;
            for (this[e] = 255 & t; ++o < n && (i *= 256);) this[e + o] = t / i & 255;
            return e + n
        },
        u.prototype.writeUIntBE = function(t, e, n, r) { (t = +t, e |= 0, n |= 0, r) || P(this, t, e, n, Math.pow(2, 8 * n) - 1, 0);
            var i = n - 1,
            o = 1;
        ...
        u.prototype.writeUInt16LE = function(t, e, n) {
            ...
            u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : k(this, t, e, !0),
            e + 2
        },
        u.prototype.writeUInt16BE = function(t, e, n) {
            ...
            e |= 0,
            n || P(this, t, e, 2, 65535, 0),
            u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : k(this, t, e, !1),
            e + 2
        },
        u.prototype.writeUInt32LE = function(t, e, n) {
            ...
            u.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : L(this, t, e, !0),
            e + 4
        },
        u.prototype.writeUInt32BE = function(t, e, n) {
            ...
            e |= 0,
            n || P(this, t, e, 4, 4294967295, 0),
            u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : L(this, t, e, !1),
            e + 4
        },
        u.prototype.writeIntLE = function(t, e, n, r) {
            ...
            s = 1,
            a = 0;
            for (this[e] = 255 & t; ++o < n && (s *= 256);) t < 0 && 0 === a && 0 !== this[e + o - 1] && (a = 1),
        ...
        u.prototype.writeInt32LE = function(t, e, n) {
            ...
            u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : L(this, t, e, !0),
            e + 4
        },
            ...
            o = [], s = 0; s < r; ++s) {
                if ((n = t.charCodeAt(s)) > 55295 && n < 57344) {
                    if (!i) {
                        ...
                        if (s + 1 === r) { (e -= 3) > -1 && o.push(239, 191, 189);
                            continue
                        }
                        i = n;
                        continue
...
function(t, e, n) { (function() {
        ...
        t.exports = function(t) {
            ...
            n.prototype.document = function(t) {
                var e, n, i, o, s;
                for (this.textispresent = !1, o = "", n = 0, i = (s = t.children).length; n < i; n++) e = s[n],
                o +=
                function() {
                    switch (!1) {
                    case ! (e instanceof u) : return this.declaration(e);
                    case ! (e instanceof c) : return this.docType(e);
                    case ! (e instanceof r) : return this.comment(e);
                    case ! (e instanceof h) : return this.processingInstruction(e);
                    default:
            ...
            n.prototype.docType = function(t, n) {
                ...
                if (n || (n = 0), f = this.space(n), f += "<!DOCTYPE " + t.root().name, t.pubID && t.sysID ? f += ' PUBLIC "' + t.pubID + '" "' + t.sysID + '"': t.sysID && (f += ' SYSTEM "' + t.sysID + '"'), t.children.length > 0) {
                    for (f += " [", f += this.newline, c = 0, l = (p = t.children).length; c < l; c++) u = p[c],
                    f +=
                    function() {
                        switch (!1) {
                        case ! (u instanceof i) : return this.dtdAttList(u, n + 1);
                        case ! (u instanceof o) : return this.dtdElement(u, n + 1);
                        case ! (u instanceof s) : return this.dtdEntity(u, n + 1);
                        case ! (u instanceof a) : return this.dtdNotation(u, n + 1);
                        case ! (u instanceof e) : return this.cdata(u, n + 1);
                        case ! (u instanceof r) : return this.comment(u, n + 1);
                        case ! (u instanceof h) : return this.processingInstruction(u, n + 1);
                        default:
            ...
            n.prototype.element = function(t, n) {
                ...
                else if (this.pretty && 1 === t.children.length && null != t.children[0].value) g += ">",
                g += t.children[0].value,
                g += "</" + t.name + ">" + this.newline;
                else {
                    if (this.dontprettytextnodes) for (s = 0, u = (_ = t.children).length; s < u; s++) if (null != (o = _[s]).value) {
                        this.textispresent++,
                        v = !0;
                        break
                    }
                    for (this.textispresent && (this.newline = "", this.pretty = !1, w = this.space(n)), g += ">" + this.newline, a = 0, c = (b = t.children).length; a < c; a++) o = b[a],
                    g +=
                    function() {
                        switch (!1) {
                        case ! (o instanceof e) : return this.cdata(o, n + 1);
                        case ! (o instanceof r) : return this.comment(o, n + 1);
                        case ! (o instanceof l) : return this.element(o, n + 1);
                        case ! (o instanceof f) : return this.raw(o, n + 1);
                        case ! (o instanceof p) : return this.text(o, n + 1);
                        case ! (o instanceof h) : return this.processingInstruction(o, n + 1);
                        default:
            ...
            n.prototype.dtdEntity = function(t, e) {
                ...
                t.pe && (n += " %"),
                n += " " + t.name,
                t.value ? n += ' "' + t.value + '"': (t.pubID && t.sysID ? n += ' PUBLIC "' + t.pubID + '" "' + t.sysID + '"': t.sysID && (n += ' SYSTEM "' + t.sysID + '"'), t.nData && (n += " NDATA " + t.nData)),
                n += this.spacebeforeslash + ">" + this.newline
            },
            ...
            n.prototype.closeNode = function(t, e) {
                ...
                case ! (t instanceof c) : return this.space(e) + "]>" + this.newline
                }
            },
            n
        } ()
...
function(t, e, n) {
    ...
    o.prototype._destroy = function(t, e) {
        var n = this;
        r.prototype._destroy.call(this, t,
        function(t) {
            e(t),
            n.emit("close")
        })
...
function(t, e, n) {
    ...
    t.exports = {
        destroy: function(t, e) {
            ...
            return o || s ? (e ? e(t) : !t || this._writableState && this._writableState.errorEmitted || r.nextTick(i, this, t), this) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(t || null,
            function(t) { ! e && t ? (r.nextTick(i, n, t), n._writableState && (n._writableState.errorEmitted = !0)) : e && e(t)
            }), this)
        },
        undestroy: function() {
...
function(t, e, n) {
    "use strict"; (function(e, r) {
        ...
        function _(t, e) {
            ...
            this.decoder = null,
            this.encoding = null,
            t.encoding && (d || (d = n(22).StringDecoder), this.decoder = new d(t.encoding), this.encoding = t.encoding)
        }
        function b(t) {
        ...
        function v(t, e, n, r) {
            e.flowing && 0 === e.length && !e.sync ? (t.emit("data", n), t.read(0)) : (e.length += e.objectMode ? 1 : n.length, r ? e.buffer.unshift(n) : e.buffer.push(n), e.needReadable && x(t)),
            D(t, e)
        }
        ...
        b.prototype.push = function(t, e) {
            ...
            return r.objectMode ? n = !0 : "string" == typeof t && ((e = e || r.defaultEncoding) !== r.encoding && (t = c.from(t, e), e = ""), n = !0),
            w(this, t, e, !1, n)
        },
        ...
        function T(t, e) {
            return t <= 0 || 0 === e.length && e.ended ? 0 : e.objectMode ? 1 : t != t ? e.flowing && e.length ? e.buffer.head.data.length: e.length: (t > e.highWaterMark && (e.highWaterMark = function(t) {
                return t >= E ? t = E: (t--, t |= t >>> 1, t |= t >>> 2, t |= t >>> 4, t |= t >>> 8, t |= t >>> 16, t++),
                t
        ...
        function x(t) {
            ...
            e.needReadable = !1,
            e.emittedReadable || (p("emitReadable", e.flowing), e.emittedReadable = !0, e.sync ? i.nextTick(A, t) : A(t))
        }
        function A(t) {
            p("emit readable"),
            t.emit("readable"),
        ...
        function C(t, e) {
            return 0 === e.length ? null: (e.objectMode ? n = e.buffer.shift() : !t || t >= e.length ? (n = e.decoder ? e.buffer.join("") : 1 === e.buffer.length ? e.buffer.head.data: e.buffer.concat(e.length), e.buffer.clear()) : n = function(t, e, n) {
                var r;
                t < e.head.data.length ? (r = e.head.data.slice(0, t), e.head.data = e.head.data.slice(t)) : r = t === e.head.data.length ? e.shift() : n ?
                function(t, e) {
                    var n = e.head,
                    r = 1,
                    i = n.data;
        ...
        b.prototype.read = function(t) {
            ...
            null;
            if (0 === (t = T(t, e)) && e.ended) return 0 === e.length && P(this),
            null;
            var r, i = e.needReadable;
            return p("need readable", i),
            (0 === e.length || e.length - t < e.highWaterMark) && p("length less than watermark", i = !0),
            e.ended || e.reading ? p("reading or ended", i = !1) : i && (p("do read"), e.reading = !0, e.sync = !0, 0 === e.length && (e.needReadable = !0), this._read(e.highWaterMark), e.sync = !1, e.reading || (t = T(n, e))),
            null === (r = t > 0 ? C(t, e) : null) ? (e.needReadable = !0, t = 0) : e.length -= t,
            0 === e.length && (e.ended || (e.needReadable = !0), n !== t && e.ended && P(this)),
        ...
        b.prototype.pipe = function(t, e) {
            ...
            var h = function(t) {
                return function() {
                    ...
                    0 === e.awaitDrain && a(t, "data") && (e.flowing = !0, O(t))
                }
            } (n);
            t.on("drain", h);
            var f = !1;
            ...
            function y(e) {
                p("ondata"),
                d = !1,
                !1 !== t.write(e) || d || ((1 === o.pipesCount && o.pipes === t || o.pipesCount > 1 && -1 !== L(o.pipes, t)) && !f && (p("false write response, pause", n._readableState.awaitDrain), n._readableState.awaitDrain++, d = !0), n.pause())
            }
            function g(e) {
                p("onerror", e),
                b(),
        ...
        b.prototype.resume = function() {
            ...
            return t.flowing || (p("resume"), t.flowing = !0,
            function(t, e) {
        ...
        b.prototype.wrap = function(t) {
            ...
            function(i) { (p("wrapped data"), n.decoder && (i = n.decoder.write(i)), !n.objectMode || null !== i && void 0 !== i) && ((n.objectMode || i && i.length) && (e.push(i) || (r = !0, t.pause())))
...
function(t, e, n) {
    ...
    t.exports = function() {
        ...
        t.prototype.concat = function(t) {
            ...
            for (var e, n, i, o = r.allocUnsafe(t >>> 0), s = this.head, a = 0; s;) e = s.data,
            n = o,
            i = a,
            e.copy(n, i),
            a += s.data.length,
...
function(t, e, n) {
    ...
    i.prototype.pipe = function(t, e) {
        ...
        n.on("data", i),
        t.on("drain", o),
        t._isStdio || e && !1 === e.end || (n.on("end", a), n.on("close", u));
        var s = !1;
        function a() {
            s || (s = !0, t.end())
        }
...
function(t, e, n) {
    ...
    e.toByteArray = function(t) {
        for (var e, n = c(t), r = n[0], s = n[1], a = new o(function(t, e, n) {
            return 3 * (e + n) / 4 - n
        } (0, r, s)), u = 0, l = s > 0 ? r - 4 : r, h = 0; h < l; h += 4) e = i[t.charCodeAt(h)] << 18 | i[t.charCodeAt(h + 1)] << 12 | i[t.charCodeAt(h + 2)] << 6 | i[t.charCodeAt(h + 3)],
        a[u++] = e >> 16 & 255,
        a[u++] = e >> 8 & 255,
        a[u++] = 255 & e;
    ...
    e.fromByteArray = function(t) {
        ...
        i = n % 3,
        o = [], s = 0, a = n - i; s < a; s += 16383) o.push(l(t, s, s + 16383 > a ? a: s + 16383));
        1 === i ? (e = t[n - 1], o.push(r[e >> 2] + r[e << 4 & 63] + "==")) : 2 === i && (e = (t[n - 2] << 8) + t[n - 1], o.push(r[e >> 10] + r[e >> 4 & 63] + r[e << 2 & 63] + "="));
        return o.join("")
    };
    for (var r = [], i = [], o = "undefined" != typeof Uint8Array ? Uint8Array: Array, s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", a = 0, u = s.length; a < u; ++a) r[a] = s[a],
    i[s.charCodeAt(a)] = a;
    function c(t) {
        var e = t.length;
    ...
    function l(t, e, n) {
        for (var i, o, s = [], a = e; a < n; a += 3) i = (t[a] << 16 & 16711680) + (t[a + 1] << 8 & 65280) + (255 & t[a + 2]),
        ...
        function(e) {
            ...
            o.prototype = {
                ...
                write: function(t) {
                    ...
                    case A.SCRIPT_ENDING:
                        ...
                        continue;
                    case A.OPEN_WAKA:
                        if ("!" === r) this.state = A.SGML_DECL,
                        this.sgmlDecl = "";
                        else if (m(r));
                        else if (w(p, r)) this.state = A.OPEN_TAG,
                        this.tagName = r;
                        else if ("/" === r) this.state = A.CLOSE_TAG,
                        this.tagName = "";
                        else if ("?" === r) this.state = A.PROC_INST,
                    ...
                    case A.SGML_DECL_QUOTED:
                        r === this.q && (this.state = A.SGML_DECL, this.q = ""),
                        this.sgmlDecl += r;
                        continue;
                    case A.DOCTYPE:
                    ...
                    case A.DOCTYPE_QUOTED:
                        this.doctype += r,
                        r === this.q && (this.q = "", this.state = A.DOCTYPE);
                        continue;
                    case A.DOCTYPE_DTD:
                        this.doctype += r,
                        "]" === r ? this.state = A.DOCTYPE: _(r) && (this.state = A.DOCTYPE_DTD_QUOTED, this.q = r);
                        continue;
                    case A.DOCTYPE_DTD_QUOTED:
                        this.doctype += r,
                        r === this.q && (this.state = A.DOCTYPE_DTD, this.q = "");
                        continue;
                    case A.COMMENT:
                    ...
                    case A.ATTRIB_NAME_SAW_WHITE:
                        if ("=" === r) this.state = A.ATTRIB_VALUE;
                            ...
                            this.attribName = "",
                            ">" === r ? B(this) : w(p, r) ? (this.attribName = r, this.state = A.ATTRIB_NAME) : (k(this, "Invalid attribute name"), this.state = A.ATTRIB)
                        }
                        continue;
                    case A.ATTRIB_VALUE:
                        if (m(r)) continue;
                ...
                flush: function() {
                    var t;
                    S(t = this),
                    "" !== t.cdata && (N(t, "oncdata", t.cdata), t.cdata = ""),
                    "" !== t.script && (N(t, "onscript", t.script), t.script = "")
                }
            };
            try {
                r = n(49).Stream
            ...
            function a(t, e) {
                ...
                s.forEach(function(t) {
                    Object.defineProperty(n, "on" + t, {
                        ...
                        set: function(e) {
                            if (!e) return n.removeAllListeners(t),
                            n._parser["on" + t] = e,
                            e;
                            n.on(t, e)
                        },
            ...
            function M(t) {
                if (t.strict || (t.attribName = t.attribName[t.looseCase]()), -1 !== t.attribList.indexOf(t.attribName) || t.tag.attributes.hasOwnProperty(t.attribName)) t.attribName = t.attribValue = "";
                    ...
                    if (t.opt.xmlns) {
                        ...
                        n = e.prefix,
                        r = e.local;
                        if ("xmlns" === n) if ("xml" === r && t.attribValue !== l) k(t, "xml: prefix must be bound to " + l + "\nActual: " + t.attribValue);
            ...
            function B(t, e) {
                if (t.opt.xmlns) {
                    ...
                    n.local = r.local,
                    n.uri = n.ns[r.prefix] || "",
                    n.prefix && !n.uri && (k(t, "Unbound namespace prefix: " + JSON.stringify(t.tagName)), n.uri = r.prefix);
                    ...
                    s = t.attribList.length; o < s; o++) {
                        ...
                        h && "xmlns" !== h && !p && (k(t, "Unbound namespace prefix: " + JSON.stringify(h)), d.uri = h),
                ...
                t.tags.push(t.tag),
                N(t, "onopentag", t.tag),
                e || (t.noscript || "script" !== t.tagName.toLowerCase() ? t.state = A.TEXT: t.state = A.SCRIPT, t.tag = null, t.tagName = ""),
                t.attribName = t.attribValue = "",
                t.attribList.length = 0
            }
            function U(t) {
            ...
            A = e.STATE,
            String.fromCodePoint || (E = String.fromCharCode, T = Math.floor, x = function() {
                var t, e, n = [],
                r = -1,
                i = arguments.length;
                if (!i) return "";
                for (var o = ""; ++r < i;) {
                    ...
                    (r + 1 === i || n.length > 16384) && (o += E.apply(null, n), n.length = 0)
                }
                return o
            },
...
function(t, e, n) { (function() {
        ...
        e.Parser = function(n) {
            function f(t) {
                ...
                i = r[.2]) h.call(i, n) && (o = i[n], this.options[n] = o);
                for (n in t) h.call(t, n) && (o = t[n], this.options[n] = o);
                this.options.xmlns && (this.options.xmlnskey = this.options.attrkey + "ns"),
                this.options.normalizeTags && (this.options.tagNameProcessors || (this.options.tagNameProcessors = []), this.options.tagNameProcessors.unshift(a.normalize)),
                this.reset()
            }
            return function(t, e) {
            ...
            f.prototype.reset = function() {
                ...
                function(t) {
                    if (i.saxParser.resume(), !i.saxParser.errThrown) return i.saxParser.errThrown = !0,
                    i.emit("error", t)
                }),
                ...
                this.saxParser.onopentag = function(n) {
                    return function(i) {
                        var o, a, u, c, l;
                        if ((u = {})[e] = "", !n.options.ignoreAttrs) for (o in l = i.attributes) h.call(l, o) && (t in u || n.options.mergeAttrs || (u[t] = {}), a = n.options.attrValueProcessors ? s(n.options.attrValueProcessors, i.attributes[o], o) : i.attributes[o], c = n.options.attrNameProcessors ? s(n.options.attrNameProcessors, o) : o, n.options.mergeAttrs ? n.assignOrPush(u, c, a) : u[t][c] = a);
                ...
                this.saxParser.onclosetag = function(t) {
                    return function() {
                        ...
                        } ()), t.options.explicitChildren && !t.options.mergeAttrs && "object" == typeof l) if (t.options.preserveChildrenOrder) {
                            if (d) {
                                for (a in d[t.options.childkey] = d[t.options.childkey] || [], f = {},
                                l) h.call(l, a) && (f[a] = l[a]);
                                d[t.options.childkey].push(f),
                                delete l["#name"],
                                1 === Object.keys(l).length && e in l && !t.EXPLICIT_CHARKEY && (l = l[e])
                            }
                        } else u = {},
                        t.options.attrkey in l && (u[t.options.attrkey] = l[t.options.attrkey], delete l[t.options.attrkey]),
                        !t.options.charsAsChildren && t.options.charkey in l && (u[t.options.charkey] = l[t.options.charkey], delete l[t.options.charkey]),
                ...
                n = function(t) {
                    return function(n) {
                        var i, o;
                        if (o = r[r.length - 1]) return o[e] += n,
                        t.options.explicitChildren && t.options.preserveChildrenOrder && t.options.charsAsChildren && (t.options.includeWhiteChars || "" !== n.replace(/\\n/g, "").trim()) && (o[t.options.childkey] = o[t.options.childkey] || [], (i = {
                            "#name": "__text__"
                        })[e] = n, t.options.normalize && (i[e] = i[e].replace(/\s{2,}/g, " ").trim()), o[t.options.childkey].push(i)),
                        o
                    }
                } (this),
            ...
            f.prototype.parseString = function(e, n) {
                var r;
                null != n && "function" == typeof n && (this.on("end",
                function(t) {
                    return this.reset(),
                    n(null, t)
                }), this.on("error",
                ...
                try {
                    ...
                    if (r = t, !this.saxParser.errThrown && !this.saxParser.ended) return this.emit("error", r),
        ...
        e.parseString = function(t, n, r) {
            var i, o;
            return null != r ? ("function" == typeof r && (i = r), "object" == typeof n && (o = n)) : ("function" == typeof n && (i = n), o = {}),
...
function(t, e, n) { (function() {
        ...
        t.exports = function(t) {
            ...
            n.prototype.document = function(t) {
                ...
                case ! (e instanceof u) : f.push(this.declaration(e));
                    break;
                case ! (e instanceof c) : f.push(this.docType(e));
                    break;
                case ! (e instanceof r) : f.push(this.comment(e));
                    break;
                case ! (e instanceof h) : f.push(this.processingInstruction(e));
                    break;
                default:
            ...
            n.prototype.docType = function(t, n) {
                ...
                if (n || (n = 0), this.stream.write(this.space(n)), this.stream.write("<!DOCTYPE " + t.root().name), t.pubID && t.sysID ? this.stream.write(' PUBLIC "' + t.pubID + '" "' + t.sysID + '"') : t.sysID && this.stream.write(' SYSTEM "' + t.sysID + '"'), t.children.length > 0) {
                    ...
                    case ! (u instanceof i) : this.dtdAttList(u, n + 1);
                        break;
                    case ! (u instanceof o) : this.dtdElement(u, n + 1);
                        break;
                    case ! (u instanceof s) : this.dtdEntity(u, n + 1);
                        break;
                    case ! (u instanceof a) : this.dtdNotation(u, n + 1);
                        break;
                    case ! (u instanceof e) : this.cdata(u, n + 1);
                        break;
                    case ! (u instanceof r) : this.comment(u, n + 1);
                        break;
                    case ! (u instanceof h) : this.processingInstruction(u, n + 1);
                        break;
                    default:
                        throw new Error("Unknown DTD node type: " + u.constructor.name)
                    }
            ...
            n.prototype.element = function(t, n) {
                ...
                this.stream.write("</" + t.name + ">");
                    ...
                    case ! (o instanceof e) : this.cdata(o, n + 1);
                        break;
                    case ! (o instanceof r) : this.comment(o, n + 1);
                        break;
                    case ! (o instanceof l) : this.element(o, n + 1);
                        break;
                    case ! (o instanceof f) : this.raw(o, n + 1);
                        break;
                    case ! (o instanceof p) : this.text(o, n + 1);
                        break;
                    case ! (o instanceof h) : this.processingInstruction(o, n + 1);
                        break;
                    default:
                        throw new Error("Unknown XML node type: " + o.constructor.name)
                    }
...
function(t, e, n) { (function() {
        ...
        t.exports = function() {
            function t(t, e, n) {
                var r;
                t || (t = {}),
                t.writer ? b(t.writer) && (r = t.writer, t.writer = new d(r)) : t.writer = new d(t),
                this.options = t,
                this.writer = t.writer,
                this.stringify = new y(t),
                this.onDataCallback = e ||
                function() {},
                this.onEndCallback = n ||
                function() {},
            ...
            t.prototype.attribute = function(t, n) {
                ...
                if (null != t && (t = t.valueOf()), _(t)) for (r in t) v.call(t, r) && (i = t[r], this.attribute(r, i));
                else m(n) && (n = n.apply()),
            ...
            t.prototype.instruction = function(t, e) {
                var n, r, i, o, s;
                if (this.openCurrent(), null != t && (t = t.valueOf()), null != e && (e = e.valueOf()), Array.isArray(t)) for (n = 0, o = t.length; n < o; n++) r = t[n],
                this.instruction(r);
                else if (_(t)) for (r in t) v.call(t, r) && (i = t[r], this.instruction(r, i));
                else m(e) && (e = e.apply()),
                s = new f(this, t, e),
            ...
            t.prototype.openNode = function(t) {
                if (!t.isOpen) return ! this.root && 0 === this.currentLevel && t instanceof h && (this.root = t),
...
function(t, e, n) { (function() {
        ...
        e.Builder = function() {
            function e(t) {
                ...
                n = r[.2]) a.call(n, e) && (i = n[e], this.options[e] = i);
            ...
            return e.prototype.buildObject = function(e) {
                ...
                u = function(t, e) {
                    ...
                    if ("object" != typeof e) h.options.cdata && o(e) ? t.raw(s(e)) : t.txt(e);
                        ...
                        for (f in e) if (a.call(e, f)) for (p in c = e[f]) l = c[p],
                        t = u(t.ele(p), l).up()
                    } else for (p in e) if (a.call(e, p)) if (c = e[p], p === n) {
                        if ("object" == typeof c) for (r in c) d = c[r],
                        t = t.att(r, d)
                    } else if (p === i) t = h.options.cdata && o(c) ? t.raw(s(c)) : t.txt(c);
                    else if (Array.isArray(c)) for (f in c) a.call(c, f) && (t = "string" == typeof(l = c[f]) ? h.options.cdata && o(l) ? t.ele(p).raw(s(l)).up() : t.ele(p, l).up() : u(t.ele(p), l).up());
...
function(t, e, n) {
    const i = n(59).parseString; (function() {
        ...
        function c(t, e, n) {
            ...
            return e && (n && (e = e.transition(100)), e.attr("height", r[1]).attr("width", r[0])),
            r
        }
        function l(t) {
        ...
        d3.layout.phylotree = function(w) {
            ...
            function et(t, e) {
                ...
                function(t) {
                    function e(t, n) {
                        t.clade && (t.clade.forEach(e), t.children = t.clade, delete t.clade),
                    ...
                    var n;
                    return i(t,
                    function(t, r) { (n = r.phyloxml.phylogeny[0].clade[0]).name = "root",
                        e(n)
                    }),
                    {
                        json: n,
                    ...
                    t;
                    var r = {}; (Y = D.call(this, n.json)).forEach(t = >{
                        if (t.name) {
            ...
            et.placenodes = function() {
                ...
                function p(t) {
                    ...
                    0), e == t.children.length) return t.notshown = !0,
                    void(t.x = void 0);
                ...
                function d(d) {
                    if (!o(d)) {
                        var y = l(d);
                        if (d.text_angle = null, d.text_align = null, d.radius = null, d.angle = null, d.parent) if (a) {
                            if (u) return 0;
                            if (d.y = P(d), void 0 === d.y) return u = !0,
                            0;
                            d.y += d.parent.y
                        ...
                        if (y) {
                            ...
                            if (f(d) && !c) {
                                if (i = t, s = .5 * r, c = !0, p(d), c = !1, "number" == typeof d.x) {
                                    ...
                                    var m = function(e) {
                                        e.hidden = !0,
                                        l(e) ? (t = e.x = i + (e.x - i) * F.compression + s, d.collapsed.push([e.x, e.y])) : e.children.map(m)
                                    };
                                    t = i,
                                    m(d),
                ...
                var y = !1;
                function g() {
                    if (et.radial() && y && (Q[1] = 0), "fixed-step" == F["left-right-spacing"]) I[1] = h * X[1],
                    ...
                    et.radial();
                        ...
                        label_width = et._label_width(shown_font_size),
                        y = !0;
                        var t = I[1] - Q[1] - F["left-offset"];.5 * t < label_width && (shown_font_size *= .5 * t / label_width, label_width = .5 * t),
            ...
            et.handle_node_click = function(t) {
                ...
                if (e.empty() && (e = d3.select(A.container).append("ul").attr("id", "d3_layout_phylotree_context_menu").attr("class", "dropdown-menu").attr("role", "menu")), e.selectAll("li").remove(), t) {
                    if (!_.some([Boolean(t.menu_items), F.hide, F.selectable, F.collapsible]) || !F["show-menu"]) return;
                    l(t) || (F.collapsible && (e.append("li").append("a").attr("tabindex", "-1").text(f(t) ? "Expand Subtree": "Collapse Subtree").on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.toggle_collapse(t).update()
                    }), F.selectable && (e.append("li").attr("class", "divider"), e.append("li").attr("class", "dropdown-header").text("Toggle selection"))), F.selectable && (e.append("li").append("a").attr("tabindex", "-1").text("All descendant branches").on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.select_all_descendants(t, !0, !0))
                    }), e.append("li").append("a").attr("tabindex", "-1").text("All terminal branches").on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.select_all_descendants(t, !0, !1))
                    }), e.append("li").append("a").attr("tabindex", "-1").text("All internal branches").on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.select_all_descendants(t, !1, !0))
                    }))),
                    t.parent && (F.selectable && (e.append("li").append("a").attr("tabindex", "-1").text("Incident branch").on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.modify_selection([t])
                    }), e.append("li").append("a").attr("tabindex", "-1").text("Path to root").on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.path_to_root(t))
                    }), (F.reroot || F.hide) && e.append("li").attr("class", "divider")), F.reroot && e.append("li").append("a").attr("tabindex", "-1").text("Reroot on this node").on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.reroot(t).update()
                    }), F.hide && e.append("li").append("a").attr("tabindex", "-1").text("Hide this " + (l(t) ? "node": "subtree")).on("click",
                    function(n) {
                        e.style("display", "none"),
                        et.modify_selection([t], "notshown", !0, !0).update_has_hidden_nodes().update()
                    })),
                    h(t) && e.append("li").append("a").attr("tabindex", "-1").text("Show all descendant nodes").on("click",
                    function(n) {
                        e.style("display", "none"),
                    ...
                    if ("menu_items" in t && "object" == typeof t.menu_items && t.menu_items.forEach(function(e) {
                        ...
                        _.some(r) && e.append("li").attr("class", "divider"),
            ...
            et.get_newick = function(t) {
                ...
                function n(r) {
                    ...
                    e.push((i = R(r), /[\s\[\]\,\)\(\:\'\"]/.test(i) ? "'" + i.replace("'", "''") + "'": i)),
                    e.push(t(r));
                    var o = P(r);
                    void 0 !== o && e.push(":" + o)
                } (Y[0]),
            ...
            et.max_parsimony = function(t) {
                ...
                function t(e) {
                    if (e.mp = [[0, 0], [!1, !1]], l(e)) e.mp[1][0] = e.mp[1][1] = e[selection_attribute_name] || !1,
            ...
            et.node_span = function(t) {
                return arguments.length ? (O = "string" == typeof t && "equal" == t ?
                function(t) {
                    return 1
                }: t, et) : O
            },
            ...
            et.traverse_and_compute = function(t, e) {
                return "post-order" == (e = e || "post-order") && (e = function e(n) {
                    if (n.children) for (var r = 0; r < n.children.length; r++) e(n.children[r]);
                    t(n)
                }),
                e(Y[0]),
                et
                ...
                if (t.parent) {
                    ...
                    if (n.parent) {
                        for (t.__mapped_bl = void 0 === t.__mapped_bl ? void 0 : .5 * t.__mapped_bl, r = n.__mapped_bl, n.__mapped_bl = t.__mapped_bl, new_json.children.push(n); n.parent;) {
                            ...
                            void 0 !== o && (n.parent.__mapped_bl = r, r = o),
                            e = n,
                            n = n.parent
                        }
                    ...
                    if (1 == n.children.length) r && (n.children[0].__mapped_bl += r),
            ...
            et.node_circle_size = function(t, e) {
                return arguments.length ? (F.node_circle_size = d3.functor(void 0 === t ? 3 : t), et) : F.node_circle_size
            },
            et.needs_redraw = function() {
                return M
            },
            et.svg = function(t) {
                return arguments.length ? (B !== t && (B = t, "phylotree-container" == j["tree-container"] && (B.selectAll("*").remove(), svg_defs = B.append("defs")), d3.select(A.container).on("click",
                function(t) {
            ...
            et.options = function(t, e) {
                ...
                var n = !1;
                for (var r in F) if (r in t && t[r] != F[r]) switch (n = !0, F[r] = t[r], r) {
                case "branches":
                    switch (t[r]) {
                    case "straight":
            ...
            et.update = function(t) {
                ...
                if (r.enter().append("g").attr("class", j["tree-container"]), r.attr("transform",
                function(t) {
                    return E([Q[1] + F["left-offset"], et.pad_height()])
                }), draw_scale_bar) {
                    var i = B.selectAll("." + j["tree-scale-bar"]).data([0]);
                    i.enter().append("g"),
                    i.attr("class", j["tree-scale-bar"]).style("font-size", J(K)).attr("transform",
                    function(t) {
                ...
                var o = r.selectAll(d(j)).data(z.filter(s),
                function(t) {
                ...
                var a = r.selectAll(y(j)).data(Y.filter(f),
                function(t) {
                    return t.id || (t.id = ++e)
                }),
                u = function() {},
                ...
                } else u = d3.svg.line().interpolate("basis").y(function(t) {
                    return t[0]
                }).x(function(t) {
                    return t[1]
                }),
                ...
                t ? (a.enter().insert("path", ":first-child"), a.attr("class", j.clade).attr("d",
                function(t) {
                ...
                })) : (a.enter().insert("path", ":first-child"), a.attr("class", j.clade).attr("d",
                function(t) {
                    return t.collapsed_clade = u(t.collapsed)
                }));
                var g = r.selectAll(p(j)).data(Y.filter(n),
                function(t) {
                    return t.id || (t.id = ++e)
                });
                g.enter().append("g");
                t ? (g.exit().transition().remove(), g = g.attr("transform",
                function(t) {
                ...
                F["label-nodes-with-name"] && g.attr("id",
                function(t) {
                    return "node-" + t.name
                });
                var m = c(et, B, t);
                if (F.brush) {
                    ...
                    var w = d3.svg.brush().x(d3.scale.identity().domain([0, m[0] - Q[1] - F["left-offset"]])).y(d3.scale.identity().domain([0, m[1] - et.pad_height()])).on("brush",
                    function() {
                ...
                if (et.sync_edge_labels(), F.zoom) {
                    var v = d3.behavior.zoom().scaleExtent([.1, 10]).on("zoom",
                    function() {
            ...
            et.path_to_root = function(t) {
                for (var e = []; t;) e.push(t),
                t = t.parent;
                return e
            },
            et.draw_edge = function(t, e, n) { (t = d3.select(t)).attr("class", et.reclass_edge).on("click",
                function(t) {
                    et.modify_selection([t.target], selection_attribute_name)
                });
                var r = draw_branch([e.source, e.target]);
                n ? (t.datum().existing_path && t.attr("d",
                function(t) {
            ...
            et.draw_node = function(t, e, n) {
                if (t = d3.select(t), l(e)) {
                    var r = t.selectAll("text").data([e]),
                    i = t.selectAll("line");
                    if (n ? r.enter().append("text").style("opacity", 0).transition().style("opacity", 1) : r.enter().append("text"), r.on("click", et.handle_node_click).attr("dy",
                    function(t) {
                    ...
                    }), et.radial() ? (n ? r.transition() : r).attr("transform",
                    function(t) {
                        return T(t.text_angle) + E(et.align_tips() ? et.shift_tip(t) : null)
                    }).attr("text-anchor",
                    function(t) {
                        return t.text_align
                    }) : (n ? r.transition() : r).attr("text-anchor", "start").attr("transform",
                    function(t) {
                        return "right-to-left" == F.layout ? E([ - 20, 0]) : E(et.align_tips() ? et.shift_tip(t) : null)
                    }), et.align_tips() ? (i = i.data([e]), n ? (i.enter().append("line").style("opacity", 0).transition().style("opacity", 1), i.attr("x1",
                    function(t) {
                        return ("end" == t.text_align ? -1 : 1) * et.node_bubble_size(e)
                    }).attr("x2", 0).attr("y1", 0).attr("y2", 0), i.transition().attr("x2",
                    function(t) {
                        return "right-to-left" == F.layout ? t.screen_x: et.shift_tip(t)[0]
                    }).attr("transform",
                    function(t) {
                        return T(t.text_angle)
                    })) : (i.enter().append("line"), i.attr("x1",
                    function(t) {
                        return ("end" == t.text_align ? -1 : 1) * et.node_bubble_size(e)
                    }).attr("y2", 0).attr("y1", 0).transition().attr("x2",
                    function(t) {
                    ...
                    function(t) {
                        ...
                        var o = et.node_bubble_size(e); (s = t.selectAll("circle").data([o])).enter().append("circle"),
                        n && (s = s.transition()),
                        s.attr("r",
                        function(t) {
                            return t
                        }),
                        shown_font_size >= 5 && r.attr("dx",
                        function(t) {
                            return ("end" == t.text_align ? -1 : 1) * ((et.align_tips() ? 0 : o) + .33 * shown_font_size)
                        })
                    } else shown_font_size >= 5 && r.attr("dx",
                    function(t) {
                    ...
                    a > 0 ? (s.enter().append("circle"), s.attr("r",
                    function(t) {
